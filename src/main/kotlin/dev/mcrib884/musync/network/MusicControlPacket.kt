...
//?}
    enum class Action {
        PLAY_TRACK, STOP, SKIP, PAUSE, RESUME, REQUEST_SYNC, SELECT_DIMENSION, ADD_TO_QUEUE, REMOVE_FROM_QUEUE, CLEAR_QUEUE, SET_DELAY, SEEK, CYCLE_REPEAT_MODE, TOGGLE_NETHER_SYNC, FORCE_SYNC_ALL, HOTLOAD_TRACKS, CREDITS_OPENED, CREDITS_SKIP, PREVIOUS
    }
